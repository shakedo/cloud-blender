...
//         console.log('after retrieving image' + JSON.stringify(imageData, null, '   '));
   ...
   var that = {
      ...
      createNodes: function(settings, callback) {
         ...
         var cloud = cloudProviders[settings.provider],
            postRate = (settings.regionConfiguration && 
                        settings.regionConfiguration.postRatePerMinuteLimits)?settings.regionConfiguration.postRatePerMinuteLimits:20,
      ...
      deleteNodes: function(settings, callback) {
         var cloud = cloudProviders[settings.provider],
            deleteRate = (settings.regionConfiguration &&
                         settings.regionConfiguration.deleteRatePerMinuteLimits)?settings.regionConfiguration.deleteRatePerMinuteLimits:20,

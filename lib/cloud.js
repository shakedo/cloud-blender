...
if (!process.env.AZURE_STORAGE_ACCESS_KEY) {
   process.env.AZURE_STORAGE_ACCESS_KEY = 'dummy_access';
}
if (!process.env.AZURE_STORAGE_ACCOUNT) {
   process.env.AZURE_STORAGE_ACCOUNT = 'dummy_access';
}
...
module.exports = (function() {
   ...
   // ----------------
   //
   // This following ifs are for preventing from crahs in azure.js if the env is not
   // here.

...
module.exports = (function() {
   ...
   function generateEC2RequestV4(settings, callback) {
      var body,
         requestSettings,
         uriStr,
         authHeader,
   ...
   function generateEC2Request(settings, callback) {
      ...
      // For old regions we want to use v2 for AlleyCat version.
      // The V2 version can be safely removed after AlleyCat is released.
      if (settings.region === 'eu-central-1') {
         generateEC2RequestV4(settings, callback);
         return;
      }

...
module.exports = (function() {
   ...
   // this function build the regionAzs data strucutre.
   // if it cant find a record - it queries the cloud
   // if it fails it stopps query the cloud
   // This must be called dymanically the first time the lib is being loaded

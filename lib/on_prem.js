...
module.exports = (function() {
    ...
    function localCloudRequest(settings, callback) {
        ...
        requestSettings = {
            ...
            url: 'http://localhost:3001' + settings.path + ((settings.method === 'POST')?'':('?' + uriStr)),// TODO: make it configurable - http://localhost:3001
            headers: {
...
//            console.log('tags creation failed, polling count: ' + pollingCount + ' ' +errorTags);
    ...
    var that = {
        ...
        createRegionContext: function(regionSettings, limits, cfg) {
            ...
            cfg.injector.allImg['onprem']={truClient: injImg, mdrv: injImg, jmeter: injImg, truapi: injImg};
            cfg.schServ.allImg['onprem'] = schImg;
            cfg.webPageTest.allImg['onprem'] = img;
            cfg.resultsServ.allImg['onprem'] = reSvrImg;
            cfg.united.allImg['onprem'] = img;
            cfg.analytics.allImg['onprem'] = analyticsSvrImg;
